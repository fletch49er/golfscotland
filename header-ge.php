...
<script>
  ...
  <link rel="stylesheet" type="text/css" href="<?PHP echo get_template_directory_uri(); ?>/css/ge-course_list.css" />
...
<div class="mh-fixed-menu mh-fixed-menu--transparent-<?php echo esc_attr( $myhome_sticky_menu_transparent ); ?>">
	<?php }
									...
									<?php if ( ! empty( $myhome_lang['url'] ) ) : ?>
                                        ...
                                        ">
											<a href="<?php echo esc_url( $myhome_lang['url'] ); ?>">
												<img src="<?php echo esc_attr( $myhome_lang['country_flag_url'] ); ?>" alt="<?php echo esc_attr( $myhome_lang['native_name'] ); ?>">
											</a>
										</div>
									<?php endif; ?>
								<?php endforeach; ?>
