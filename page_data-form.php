...
<div id="wrapper" class="clearfix">
	<div id="header">
		<img id="hdr-img" src="<?php echo IMG_URL2; ?>logos/gsn-logo.png" alt="gsn-logo.png" />
	</div><!-- end #header -->
...
get_template_part('templates/course-profile_data_form');
  ...
  elseif ($valid == true) :
    ...
    endforeach;
  	...
  	$from = 'golfscotland.net';
  	$subject = 'SCOTTISH COURSE PROFILE: '.$formData['name'].'';
      ...
      echo '<p><b>Return to <a href="https://www.golfscotland.net">golfscotland.net</a> homepage</b></p>'.PHP_EOL;
  	}	else {
...
<script>
/*function validate(regex, id) {
	let value = document.getElementById(id).value;
	let placeholder = document.getElementById(id).placeholder;
	let required = document.getElementById(id).required;
	...
	if (value === '' && required === true) {
		alert ("This is a required field. This must be a valid value.\n(e.g. "+placeholder+")");
	} else if (value != '') {
		if (result == false) {
			alert("ERROR: Please provide a valid value.\n(e.g. "+placeholder+")");
		} else {
			alert(value);
		}
	}
