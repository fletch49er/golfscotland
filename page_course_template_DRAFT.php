...
// function to display tick or cross icon for course feature and facilities
...
// data queries
// data query gs_courses table - course details
...
// data query gs_courses table - feature and facilities
...
// data query gs_courses table - videos
